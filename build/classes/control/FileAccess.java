...
public class FileAccess {
    public void writeToFile(String filename , String str){
         ...
         public ArrayList<Makeappointment>readMakeappointment(){
             ArrayList<Makeappointment>allappoitment=new ArrayList();
             String line;
             String minfo[];
                try {
                 ...
                 BufferedReader in =new BufferedReader(ir);
                     while(in.ready()){
                         line=in.readLine();
                         minfo=line.split("\t");
                         Makeappointment mp=new Makeappointment((Integer.parseInt(minfo[0])),(Integer.parseInt(minfo[1])),minfo[2],minfo[3],(Integer.parseInt(minfo[4])),(Double.parseDouble(minfo[5])),"");
                         allappoitment.add(mp);
                         in.close();
                     }
                 } catch (IOException e) {}
             ...
             try {
                 ...
                 BufferedReader in =new BufferedReader(ir);
                     while(in.ready()){
                         line=in.readLine();
                         pyinfo=line.split("\t");
                         payment py=new payment((Integer.parseInt(pyinfo[0])),pyinfo[1],pyinfo[2],(Double.parseDouble(pyinfo[3])),"");
                         allpayment.add(py);
                         in.close();
                     }
                 } catch (IOException e) {}
